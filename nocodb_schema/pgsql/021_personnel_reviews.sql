...
-- Aligns with MushroomProcess conventions:
--   - nocopk first
--   - visible primary/code field second
--   - nocouuid autogenerated
--   - code field autogenerated from created date + airtable_id/nocouuid/nocopk
--
-- Suppress NOTICE chatter such as:
--   extension already exists, skipping
--   trigger/table/view does not exist, skipping
