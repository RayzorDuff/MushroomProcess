...
-- 2026-02-16T19:34:22.377Z
SET client_min_messages TO WARNING;
\set ON_ERROR_STOP on
BEGIN;
SET search_path TO "public";
\copy "strains"("airtable_id","strain_id","species_strain","regulated") FROM csv/strains.csv WITH (FORMAT csv, HEADER true);
...
\copy "items"("airtable_id","item_id","name","category","default_unit_size_lb","default_unit_size_ml","default_unit_size_oz","default_unit_size_g","default_unit_size") FROM csv/items.csv WITH (FORMAT csv, HEADER true);
\copy "locations"("airtable_id","name","type","notes") FROM csv/locations.csv WITH (FORMAT csv, HEADER true);
