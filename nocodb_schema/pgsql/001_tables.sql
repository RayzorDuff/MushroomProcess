...
DO $$ BEGIN
      ALTER TABLE "public"."strains" ADD CONSTRAINT "uq_strains_strain_id" UNIQUE ("strain_id");
...
DO $$ BEGIN
      ALTER TABLE "public"."recipes" ADD CONSTRAINT "uq_recipes_recipe_id" UNIQUE ("recipe_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
      ALTER TABLE "public"."recipes" ADD CONSTRAINT "uq_recipes_recipe_id" UNIQUE ("recipe_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
      ALTER TABLE "public"."products" ADD CONSTRAINT "uq_products_product_id" UNIQUE ("product_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
      ALTER TABLE "public"."lots" ADD CONSTRAINT "uq_lots_lot_id" UNIQUE ("lot_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
      ALTER TABLE "public"."lots" ADD CONSTRAINT "uq_lots_plate_group_id" UNIQUE ("plate_group_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
      ALTER TABLE "public"."items" ADD CONSTRAINT "uq_items_item_id" UNIQUE ("item_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN
      ALTER TABLE "public"."items" ADD CONSTRAINT "uq_items_item_id" UNIQUE ("item_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
      ALTER TABLE "public"."events" ADD CONSTRAINT "uq_events_event_id" UNIQUE ("event_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
      ALTER TABLE "public"."sterilization_runs" ADD CONSTRAINT "uq_sterilization_runs_steri_run_id" UNIQUE ("steri_run_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
      ALTER TABLE "public"."print_queue" ADD CONSTRAINT "uq_print_queue_print_id" UNIQUE ("print_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN
      ALTER TABLE "public"."ecommerce_orders" ADD CONSTRAINT "uq_ecommerce_orders_ecwid_order_id" UNIQUE ("ecwid_order_id");
    EXCEPTION WHEN duplicate_object THEN NULL; END $$;
