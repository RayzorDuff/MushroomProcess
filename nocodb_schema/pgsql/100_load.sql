...
\copy "ecommerce"("airtable_id","name","status","ecwid_sku","sync_to_ecwid","notes","ecwid_category","ecwid_price","ecwid_stock","ecwid_url","ecwid_image") FROM csv/ecommerce.csv WITH (FORMAT csv, HEADER true);
