...
DROP VIEW IF EXISTS "public"."v_item_recipe_components" CASCADE;
DROP VIEW IF EXISTS "public"."v_recipes" CASCADE;
DROP VIEW IF EXISTS "public"."v_lot_recipe_components" CASCADE;
...
SELECT
  ...
  (SELECT COALESCE(array_agg(j."items1_id" ORDER BY j."items1_id"), '{}'::bigint[]) FROM "public"."_m2m_items_items_items" j WHERE j."items_id" = t."nocopk") AS "items__items__items__ids",
  (SELECT COALESCE(array_agg(j."item_recipe_components_id" ORDER BY j."item_recipe_components_id"), '{}'::bigint[]) FROM "public"."_m2m_items_item_recipe_components_item_recipe_components" j WHERE j."items_id" = t."nocopk") AS "items__item_recipe_components__item_recipe_components__ids",
  (SELECT COALESCE(array_agg(j."lot_recipe_components_id" ORDER BY j."lot_recipe_components_id"), '{}'::bigint[]) FROM "public"."_m2m_items_lot_recipe_components_lot_recipe_components" j WHERE j."items_id" = t."nocopk") AS "items__lot_recipe_components__lot_recipe_components__ids"
FROM "public"."items" t;

CREATE VIEW "public"."v_item_recipe_components" AS
SELECT
  t.*,
  'public.item_recipe_components'::text AS __table,
  t."nocopk"::text AS __primary,
  (SELECT COALESCE(array_agg(j."lot_recipe_components_id" ORDER BY j."lot_recipe_components_id"), '{}'::bigint[]) FROM "public"."_m2m_item_recipe_components_lot_recipe_components_lo_40a5397268" j WHERE j."item_recipe_components_id" = t."nocopk") AS "item_recipe_components__lot_recipe_components__lot_recipe_components__ids"
FROM "public"."item_recipe_components" t;
...
SELECT
  ...
  (SELECT COALESCE(array_agg(j."item_recipe_components_id" ORDER BY j."item_recipe_components_id"), '{}'::bigint[]) FROM "public"."_m2m_recipes_item_recipe_components_item_recipe_components" j WHERE j."recipes_id" = t."nocopk") AS "recipes__item_recipe_components__item_recipe_components__ids",
  (SELECT COALESCE(array_agg(j."lot_recipe_components_id" ORDER BY j."lot_recipe_components_id"), '{}'::bigint[]) FROM "public"."_m2m_recipes_lot_recipe_components_lot_recipe_components" j WHERE j."recipes_id" = t."nocopk") AS "recipes__lot_recipe_components__lot_recipe_components__ids"
FROM "public"."recipes" t;

CREATE VIEW "public"."v_lot_recipe_components" AS
SELECT
  t.*,
  'public.lot_recipe_components'::text AS __table,
  t."nocopk"::text AS __primary
FROM "public"."lot_recipe_components" t;
...
SELECT
  ...
  (SELECT COALESCE(array_agg(j."lot_recipe_components_id" ORDER BY j."lot_recipe_components_id"), '{}'::bigint[]) FROM "public"."_m2m_lots_lot_recipe_components_lot_recipe_components" j WHERE j."lots_id" = t."nocopk") AS "lots__lot_recipe_components__lot_recipe_components__ids"
FROM "public"."lots" t;
