...
-- M2M_LINK: Airtable multi-link field products.item_id -> items
...
-- M2M_LINK: Airtable multi-link field lots.item_id -> items
...
-- M2M_LINK: Airtable multi-link field lots.recipe_id -> recipes
...
-- M2M_LINK: Airtable multi-link field lots.location_id -> locations
...
-- M2M_LINK: Airtable multi-link field events.lot_id -> lots
...
-- M2M_LINK: Airtable multi-link field events.product_id -> products
...
-- M2M_LINK: Airtable multi-link field print_queue.run_id -> sterilization_runs
