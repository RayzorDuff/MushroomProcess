...
DO $$ BEGIN
        IF NOT EXISTS (
          ...
          WHERE c.conname = '_m2m_strains_lots_lots_strains_id_fk'
            AND c.conrelid = 'public._m2m_strains_lots_lots'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_strains_lots_lots_lots_id_fk'
            AND c.conrelid = 'public._m2m_strains_lots_lots'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_strains_lots_lots"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_strains_ecommerce_ecommerce_strains_id_fk'
            AND c.conrelid = 'public._m2m_strains_ecommerce_ecommerce'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_strains_ecommerce_ecommerce_ecommerce_id_fk'
            AND c.conrelid = 'public._m2m_strains_ecommerce_ecommerce'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_strains_ecommerce_ecommerce"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_strains_products_products_strains_id_fk'
            AND c.conrelid = 'public._m2m_strains_products_products'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_strains_products_products_products_id_fk'
            AND c.conrelid = 'public._m2m_strains_products_products'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_strains_products_products"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_recipes_lots_lots_recipes_id_fk'
            AND c.conrelid = 'public._m2m_recipes_lots_lots'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_recipes_lots_lots_lots_id_fk'
            AND c.conrelid = 'public._m2m_recipes_lots_lots'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_recipes_lots_lots"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_recipes_sterilization_runs_sterilization_runs_r_22467f5267'
            AND c.conrelid = 'public._m2m_recipes_sterilization_runs_sterilization_runs'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_recipes_sterilization_runs_sterilization_runs_s_390c397b0b'
            AND c.conrelid = 'public._m2m_recipes_sterilization_runs_sterilization_runs'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_recipes_sterilization_runs_sterilization_runs"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_items_item_id_products_id_fk'
            AND c.conrelid = 'public._m2m_products_items_item_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_items_item_id_items_id_fk'
            AND c.conrelid = 'public._m2m_products_items_item_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_products_items_item_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_items_package_item_products_id_fk'
            AND c.conrelid = 'public._m2m_products_items_package_item'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_items_package_item_items_id_fk'
            AND c.conrelid = 'public._m2m_products_items_package_item'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_products_items_package_item"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_locations_storage_location_products_id_fk'
            AND c.conrelid = 'public._m2m_products_locations_storage_location'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_locations_storage_location_locations_id_fk'
            AND c.conrelid = 'public._m2m_products_locations_storage_location'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_products_locations_storage_location"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_products_merge_tray_products_products_id_fk'
            AND c.conrelid = 'public._m2m_products_products_merge_tray_products'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_products_merge_tray_products_products1_id_fk'
            AND c.conrelid = 'public._m2m_products_products_merge_tray_products'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_products_products_merge_tray_products"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_lots_origin_lots_products_id_fk'
            AND c.conrelid = 'public._m2m_products_lots_origin_lots'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_lots_origin_lots_lots_id_fk'
            AND c.conrelid = 'public._m2m_products_lots_origin_lots'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_products_lots_origin_lots"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_strains_strain_id_products_id_fk'
            AND c.conrelid = 'public._m2m_products_strains_strain_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_strains_strain_id_strains_id_fk'
            AND c.conrelid = 'public._m2m_products_strains_strain_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_products_strains_strain_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_print_queue_print_queue_products_id_fk'
            AND c.conrelid = 'public._m2m_products_print_queue_print_queue'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_print_queue_print_queue_print_queue_id_fk'
            AND c.conrelid = 'public._m2m_products_print_queue_print_queue'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_products_print_queue_print_queue"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_ecommerce_ecommerce_products_id_fk'
            AND c.conrelid = 'public._m2m_products_ecommerce_ecommerce'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_ecommerce_ecommerce_ecommerce_id_fk'
            AND c.conrelid = 'public._m2m_products_ecommerce_ecommerce'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_products_ecommerce_ecommerce"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_ecommerce_orders_ecommerce_orders_products_id_fk'
            AND c.conrelid = 'public._m2m_products_ecommerce_orders_ecommerce_orders'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_ecommerce_orders_ecommerce_orders_ecom_eb021abb51'
            AND c.conrelid = 'public._m2m_products_ecommerce_orders_ecommerce_orders'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_products_ecommerce_orders_ecommerce_orders"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_events_events_products_id_fk'
            AND c.conrelid = 'public._m2m_products_events_events'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_products_events_events_events_id_fk'
            AND c.conrelid = 'public._m2m_products_events_events'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_products_events_events"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_items_item_id_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_items_item_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_items_item_id_items_id_fk'
            AND c.conrelid = 'public._m2m_lots_items_item_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_items_item_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_recipes_recipe_id_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_recipes_recipe_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_recipes_recipe_id_recipes_id_fk'
            AND c.conrelid = 'public._m2m_lots_recipes_recipe_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_recipes_recipe_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_strains_strain_id_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_strains_strain_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_strains_strain_id_strains_id_fk'
            AND c.conrelid = 'public._m2m_lots_strains_strain_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_strains_strain_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_sterilization_runs_steri_run_id_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_sterilization_runs_steri_run_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_sterilization_runs_steri_run_id_sterilizat_551132c151'
            AND c.conrelid = 'public._m2m_lots_sterilization_runs_steri_run_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_sterilization_runs_steri_run_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_locations_location_id_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_locations_location_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_locations_location_id_locations_id_fk'
            AND c.conrelid = 'public._m2m_lots_locations_location_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_locations_location_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_events_events_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_events_events'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_events_events_events_id_fk'
            AND c.conrelid = 'public._m2m_lots_events_events'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_events_events"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_target_lot_ids_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_target_lot_ids'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_target_lot_ids_lots1_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_target_lot_ids'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_lots_target_lot_ids"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_grain_inputs_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_grain_inputs'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_grain_inputs_lots1_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_grain_inputs'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_lots_grain_inputs"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_substrate_inputs_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_substrate_inputs'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_substrate_inputs_lots1_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_substrate_inputs'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_lots_substrate_inputs"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_items_syringe_item_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_items_syringe_item'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_items_syringe_item_items_id_fk'
            AND c.conrelid = 'public._m2m_lots_items_syringe_item'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_items_syringe_item"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_items_harvest_item_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_items_harvest_item'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_items_harvest_item_items_id_fk'
            AND c.conrelid = 'public._m2m_lots_items_harvest_item'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_items_harvest_item"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_products_products_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_products_products'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_products_products_products_id_fk'
            AND c.conrelid = 'public._m2m_lots_products_products'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_products_products"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_casing_lot_id_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_casing_lot_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_casing_lot_id_lots1_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_casing_lot_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_lots_casing_lot_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_print_queue_print_queue_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_print_queue_print_queue'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_print_queue_print_queue_print_queue_id_fk'
            AND c.conrelid = 'public._m2m_lots_print_queue_print_queue'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_print_queue_print_queue"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_source_lot_id_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_source_lot_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_source_lot_id_lots1_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_source_lot_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_lots_source_lot_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_parent_lot_id_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_parent_lot_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_lots_parent_lot_id_lots1_id_fk'
            AND c.conrelid = 'public._m2m_lots_lots_parent_lot_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_lots_parent_lot_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_ecommerce_ecommerce_lots_id_fk'
            AND c.conrelid = 'public._m2m_lots_ecommerce_ecommerce'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_lots_ecommerce_ecommerce_ecommerce_id_fk'
            AND c.conrelid = 'public._m2m_lots_ecommerce_ecommerce'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_lots_ecommerce_ecommerce"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_lots_lots_items_id_fk'
            AND c.conrelid = 'public._m2m_items_lots_lots'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_lots_lots_lots_id_fk'
            AND c.conrelid = 'public._m2m_items_lots_lots'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_items_lots_lots"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_sterilization_runs_sterilization_runs_items_id_fk'
            AND c.conrelid = 'public._m2m_items_sterilization_runs_sterilization_runs'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_sterilization_runs_sterilization_runs_ste_a75882d208'
            AND c.conrelid = 'public._m2m_items_sterilization_runs_sterilization_runs'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_items_sterilization_runs_sterilization_runs"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_lots_lots_2_items_id_fk'
            AND c.conrelid = 'public._m2m_items_lots_lots_2'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_lots_lots_2_lots_id_fk'
            AND c.conrelid = 'public._m2m_items_lots_lots_2'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_items_lots_lots_2"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_products_products_items_id_fk'
            AND c.conrelid = 'public._m2m_items_products_products'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_products_products_products_id_fk'
            AND c.conrelid = 'public._m2m_items_products_products'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_items_products_products"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_lots_lots_4_items_id_fk'
            AND c.conrelid = 'public._m2m_items_lots_lots_4'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_lots_lots_4_lots_id_fk'
            AND c.conrelid = 'public._m2m_items_lots_lots_4'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_items_lots_lots_4"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_products_products_2_items_id_fk'
            AND c.conrelid = 'public._m2m_items_products_products_2'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_products_products_2_products_id_fk'
            AND c.conrelid = 'public._m2m_items_products_products_2'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_items_products_products_2"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_ecommerce_ecommerce_items_id_fk'
            AND c.conrelid = 'public._m2m_items_ecommerce_ecommerce'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_items_ecommerce_ecommerce_ecommerce_id_fk'
            AND c.conrelid = 'public._m2m_items_ecommerce_ecommerce'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_items_ecommerce_ecommerce"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_events_lots_lot_id_events_id_fk'
            AND c.conrelid = 'public._m2m_events_lots_lot_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_events_lots_lot_id_lots_id_fk'
            AND c.conrelid = 'public._m2m_events_lots_lot_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_events_lots_lot_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_events_products_product_id_events_id_fk'
            AND c.conrelid = 'public._m2m_events_products_product_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_events_products_product_id_products_id_fk'
            AND c.conrelid = 'public._m2m_events_products_product_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_events_products_product_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_locations_lots_lots_locations_id_fk'
            AND c.conrelid = 'public._m2m_locations_lots_lots'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_locations_lots_lots_lots_id_fk'
            AND c.conrelid = 'public._m2m_locations_lots_lots'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_locations_lots_lots"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_locations_products_products_locations_id_fk'
            AND c.conrelid = 'public._m2m_locations_products_products'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_locations_products_products_products_id_fk'
            AND c.conrelid = 'public._m2m_locations_products_products'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_locations_products_products"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_sterilization_runs_items_planned_item_steriliza_9e817300a5'
            AND c.conrelid = 'public._m2m_sterilization_runs_items_planned_item'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_sterilization_runs_items_planned_item_items_id_fk'
            AND c.conrelid = 'public._m2m_sterilization_runs_items_planned_item'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_sterilization_runs_items_planned_item"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_sterilization_runs_recipes_planned_recipe_steri_2ac55d3f2b'
            AND c.conrelid = 'public._m2m_sterilization_runs_recipes_planned_recipe'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_sterilization_runs_recipes_planned_recipe_recipes_id_fk'
            AND c.conrelid = 'public._m2m_sterilization_runs_recipes_planned_recipe'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_sterilization_runs_recipes_planned_recipe"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_sterilization_runs_lots_lots_sterilization_runs_id_fk'
            AND c.conrelid = 'public._m2m_sterilization_runs_lots_lots'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_sterilization_runs_lots_lots_lots_id_fk'
            AND c.conrelid = 'public._m2m_sterilization_runs_lots_lots'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_sterilization_runs_lots_lots"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_sterilization_runs_print_queue_print_queue_ster_1518bee7d0'
            AND c.conrelid = 'public._m2m_sterilization_runs_print_queue_print_queue'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_sterilization_runs_print_queue_print_queue_prin_140f8024f4'
            AND c.conrelid = 'public._m2m_sterilization_runs_print_queue_print_queue'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_sterilization_runs_print_queue_print_queue"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_print_queue_lots_lot_id_print_queue_id_fk'
            AND c.conrelid = 'public._m2m_print_queue_lots_lot_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_print_queue_lots_lot_id_lots_id_fk'
            AND c.conrelid = 'public._m2m_print_queue_lots_lot_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_print_queue_lots_lot_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_print_queue_products_product_id_print_queue_id_fk'
            AND c.conrelid = 'public._m2m_print_queue_products_product_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_print_queue_products_product_id_products_id_fk'
            AND c.conrelid = 'public._m2m_print_queue_products_product_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_print_queue_products_product_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_print_queue_sterilization_runs_run_id_print_queue_id_fk'
            AND c.conrelid = 'public._m2m_print_queue_sterilization_runs_run_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_print_queue_sterilization_runs_run_id_steriliza_945895739e'
            AND c.conrelid = 'public._m2m_print_queue_sterilization_runs_run_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_print_queue_sterilization_runs_run_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_items_item_id_ecommerce_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_items_item_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_items_item_id_items_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_items_item_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_ecommerce_items_item_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_strains_strain_id_ecommerce_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_strains_strain_id'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_strains_strain_id_strains_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_strains_strain_id'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_ecommerce_strains_strain_id"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_products_products_ecommerce_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_products_products'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_products_products_products_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_products_products'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_ecommerce_products_products"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_lots_lots_ecommerce_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_lots_lots'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_lots_lots_lots_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_lots_lots'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_ecommerce_lots_lots"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_ecommerce_orders_ecommerce_orders_eco_4d9221e371'
            AND c.conrelid = 'public._m2m_ecommerce_ecommerce_orders_ecommerce_orders'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_ecommerce_orders_ecommerce_orders_eco_deeee65d3d'
            AND c.conrelid = 'public._m2m_ecommerce_ecommerce_orders_ecommerce_orders'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_ecommerce_ecommerce_orders_ecommerce_orders"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_orders_products_products_ecommerce_orders_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_orders_products_products'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_orders_products_products_products_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_orders_products_products'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_ecommerce_orders_products_products"
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_orders_ecommerce_ecommerce_ecommerce__def73ffc7c'
            AND c.conrelid = 'public._m2m_ecommerce_orders_ecommerce_ecommerce'::regclass
        ) THEN
...
DO $$ BEGIN
        IF NOT EXISTS (
          SELECT 1
          FROM pg_constraint c
          WHERE c.conname = '_m2m_ecommerce_orders_ecommerce_ecommerce_ecommerce_id_fk'
            AND c.conrelid = 'public._m2m_ecommerce_orders_ecommerce_ecommerce'::regclass
        ) THEN
          ALTER TABLE "public"."_m2m_ecommerce_orders_ecommerce_ecommerce"
