...
CREATE OR REPLACE FUNCTION "public"."sync_products_package_item_id_to__m2m_products_items_package_item"()
...
DROP TRIGGER IF EXISTS "trg_products_package_item_id_to__m2m_products_items_package_item" ON "public"."products";
CREATE TRIGGER "trg_products_package_item_id_to__m2m_products_items_package_item"
AFTER INSERT OR UPDATE OF "package_item_id" ON "public"."products"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_products_package_item_id_to__m2m_products_items_package_item"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_products_items_package_item_to_products_package_item_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
BEGIN
  ...
  ELSE
    ...
    DELETE FROM "public"."_m2m_products_items_package_item"
     WHERE "products_id" = v_a
       AND "items_id" <> v_b;

    UPDATE "public"."products"
       SET "package_item_id" = v_b
     WHERE "nocopk" = v_a;
...
DROP TRIGGER IF EXISTS "trg__m2m_products_items_package_item_to_products_package_item_id" ON "public"."_m2m_products_items_package_item";
CREATE TRIGGER "trg__m2m_products_items_package_item_to_products_package_item_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_products_items_package_item"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_products_items_package_item_to_products_package_item_id"();
...
CREATE OR REPLACE FUNCTION "public"."sync_products_storage_location_id_to__m2m_products_locations_storage_location"()
RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
  -- prevent recursion when the junction trigger updates the base table
  IF pg_trigger_depth() > 1 THEN
...
DROP TRIGGER IF EXISTS "trg_products_storage_location_id_to__m2m_products_locations_storage_location" ON "public"."products";
CREATE TRIGGER "trg_products_storage_location_id_to__m2m_products_locations_storage_location"
AFTER INSERT OR UPDATE OF "storage_location_id" ON "public"."products"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_products_storage_location_id_to__m2m_products_locations_storage_location"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_products_locations_storage_location_to_products_storage_location_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    v_a := OLD."products_id";
    v_b := OLD."locations_id";
    UPDATE "public"."products"
       SET "storage_location_id" = NULL
     WHERE "nocopk" = v_a
       AND "storage_location_id" = v_b;
    RETURN OLD;
  ELSE
    v_a := NEW."products_id";
    v_b := NEW."locations_id";

    -- Enforce single link: drop any other rows for this source id
    DELETE FROM "public"."_m2m_products_locations_storage_location"
     WHERE "products_id" = v_a
       AND "locations_id" <> v_b;

    UPDATE "public"."products"
       SET "storage_location_id" = v_b
     WHERE "nocopk" = v_a;
...
DROP TRIGGER IF EXISTS "trg__m2m_products_locations_storage_location_to_products_storage_location_id" ON "public"."_m2m_products_locations_storage_location";
CREATE TRIGGER "trg__m2m_products_locations_storage_location_to_products_storage_location_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_products_locations_storage_location"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_products_locations_storage_location_to_products_storage_location_id"();
...
AFTER INSERT OR UPDATE OF "strain_id" ON "public"."products"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_products_strain_id_to__m2m_products_strains_strain_id"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_products_strains_strain_id_to_products_strain_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
...
DROP TRIGGER IF EXISTS "trg__m2m_products_strains_strain_id_to_products_strain_id" ON "public"."_m2m_products_strains_strain_id";
CREATE TRIGGER "trg__m2m_products_strains_strain_id_to_products_strain_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_products_strains_strain_id"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_products_strains_strain_id_to_products_strain_id"();
...
AFTER INSERT OR UPDATE OF "strain_id" ON "public"."lots"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_lots_strain_id_to__m2m_lots_strains_strain_id"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_lots_strains_strain_id_to_lots_strain_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
...
DROP TRIGGER IF EXISTS "trg__m2m_lots_strains_strain_id_to_lots_strain_id" ON "public"."_m2m_lots_strains_strain_id";
CREATE TRIGGER "trg__m2m_lots_strains_strain_id_to_lots_strain_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_lots_strains_strain_id"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_lots_strains_strain_id_to_lots_strain_id"();
...
CREATE OR REPLACE FUNCTION "public"."sync_lots_steri_run_id_to__m2m_lots_sterilization_runs_steri_run_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
  -- prevent recursion when the junction trigger updates the base table
  IF pg_trigger_depth() > 1 THEN
...
DROP TRIGGER IF EXISTS "trg_lots_steri_run_id_to__m2m_lots_sterilization_runs_steri_run_id" ON "public"."lots";
CREATE TRIGGER "trg_lots_steri_run_id_to__m2m_lots_sterilization_runs_steri_run_id"
AFTER INSERT OR UPDATE OF "steri_run_id" ON "public"."lots"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_lots_steri_run_id_to__m2m_lots_sterilization_runs_steri_run_id"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_lots_sterilization_runs_steri_run_id_to_lots_steri_run_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    v_a := OLD."lots_id";
    v_b := OLD."sterilization_runs_id";
    UPDATE "public"."lots"
       SET "steri_run_id" = NULL
     WHERE "nocopk" = v_a
       AND "steri_run_id" = v_b;
    RETURN OLD;
  ELSE
    v_a := NEW."lots_id";
    v_b := NEW."sterilization_runs_id";

    -- Enforce single link: drop any other rows for this source id
    DELETE FROM "public"."_m2m_lots_sterilization_runs_steri_run_id"
     WHERE "lots_id" = v_a
       AND "sterilization_runs_id" <> v_b;

    UPDATE "public"."lots"
       SET "steri_run_id" = v_b
     WHERE "nocopk" = v_a;
...
DROP TRIGGER IF EXISTS "trg__m2m_lots_sterilization_runs_steri_run_id_to_lots_steri_run_id" ON "public"."_m2m_lots_sterilization_runs_steri_run_id";
CREATE TRIGGER "trg__m2m_lots_sterilization_runs_steri_run_id_to_lots_steri_run_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_lots_sterilization_runs_steri_run_id"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_lots_sterilization_runs_steri_run_id_to_lots_steri_run_id"();
...
AFTER INSERT OR UPDATE OF "syringe_item_id" ON "public"."lots"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_lots_syringe_item_id_to__m2m_lots_items_syringe_item"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_lots_items_syringe_item_to_lots_syringe_item_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    ...
    v_b := OLD."items_id";
    UPDATE "public"."lots"
       SET "syringe_item_id" = NULL
     WHERE "nocopk" = v_a
       AND "syringe_item_id" = v_b;
    RETURN OLD;
  ELSE
    v_a := NEW."lots_id";
    v_b := NEW."items_id";
...
DROP TRIGGER IF EXISTS "trg__m2m_lots_items_syringe_item_to_lots_syringe_item_id" ON "public"."_m2m_lots_items_syringe_item";
CREATE TRIGGER "trg__m2m_lots_items_syringe_item_to_lots_syringe_item_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_lots_items_syringe_item"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_lots_items_syringe_item_to_lots_syringe_item_id"();
...
AFTER INSERT OR UPDATE OF "casing_lot_id" ON "public"."lots"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_lots_casing_lot_id_to__m2m_lots_lots_casing_lot_id"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_lots_lots_casing_lot_id_to_lots_casing_lot_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    ...
    v_b := OLD."lots1_id";
    UPDATE "public"."lots"
       SET "casing_lot_id" = NULL
     WHERE "nocopk" = v_a
       AND "casing_lot_id" = v_b;
    RETURN OLD;
  ELSE
    v_a := NEW."lots_id";
    v_b := NEW."lots1_id";
...
DROP TRIGGER IF EXISTS "trg__m2m_lots_lots_casing_lot_id_to_lots_casing_lot_id" ON "public"."_m2m_lots_lots_casing_lot_id";
CREATE TRIGGER "trg__m2m_lots_lots_casing_lot_id_to_lots_casing_lot_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_lots_lots_casing_lot_id"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_lots_lots_casing_lot_id_to_lots_casing_lot_id"();
...
AFTER INSERT OR UPDATE OF "source_lot_id" ON "public"."lots"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_lots_source_lot_id_to__m2m_lots_lots_source_lot_id"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_lots_lots_source_lot_id_to_lots_source_lot_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
...
DROP TRIGGER IF EXISTS "trg__m2m_lots_lots_source_lot_id_to_lots_source_lot_id" ON "public"."_m2m_lots_lots_source_lot_id";
CREATE TRIGGER "trg__m2m_lots_lots_source_lot_id_to_lots_source_lot_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_lots_lots_source_lot_id"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_lots_lots_source_lot_id_to_lots_source_lot_id"();
...
AFTER INSERT OR UPDATE OF "parent_lot_id" ON "public"."lots"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_lots_parent_lot_id_to__m2m_lots_lots_parent_lot_id"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_lots_lots_parent_lot_id_to_lots_parent_lot_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
...
DROP TRIGGER IF EXISTS "trg__m2m_lots_lots_parent_lot_id_to_lots_parent_lot_id" ON "public"."_m2m_lots_lots_parent_lot_id";
CREATE TRIGGER "trg__m2m_lots_lots_parent_lot_id_to_lots_parent_lot_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_lots_lots_parent_lot_id"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_lots_lots_parent_lot_id_to_lots_parent_lot_id"();
...
CREATE UNIQUE INDEX IF NOT EXISTS "_m2m_sterilization_runs_items_planned_item_sterilization_runs_id_uniq" ON "public"."_m2m_sterilization_runs_items_planned_item"("sterilization_runs_id");

CREATE OR REPLACE FUNCTION "public"."sync_sterilization_runs_planned_item_id_to__m2m_sterilization_runs_items_planned_item"()
RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
  -- prevent recursion when the junction trigger updates the base table
  IF pg_trigger_depth() > 1 THEN
...
DROP TRIGGER IF EXISTS "trg_sterilization_runs_planned_item_id_to__m2m_sterilization_runs_items_planned_item" ON "public"."sterilization_runs";
CREATE TRIGGER "trg_sterilization_runs_planned_item_id_to__m2m_sterilization_runs_items_planned_item"
AFTER INSERT OR UPDATE OF "planned_item_id" ON "public"."sterilization_runs"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_sterilization_runs_planned_item_id_to__m2m_sterilization_runs_items_planned_item"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_sterilization_runs_items_planned_item_to_sterilization_runs_planned_item_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    v_a := OLD."sterilization_runs_id";
    v_b := OLD."items_id";
    UPDATE "public"."sterilization_runs"
       SET "planned_item_id" = NULL
     WHERE "nocopk" = v_a
       AND "planned_item_id" = v_b;
    RETURN OLD;
  ELSE
    v_a := NEW."sterilization_runs_id";
    v_b := NEW."items_id";

    -- Enforce single link: drop any other rows for this source id
    DELETE FROM "public"."_m2m_sterilization_runs_items_planned_item"
     WHERE "sterilization_runs_id" = v_a
       AND "items_id" <> v_b;

    UPDATE "public"."sterilization_runs"
       SET "planned_item_id" = v_b
     WHERE "nocopk" = v_a;
...
DROP TRIGGER IF EXISTS "trg__m2m_sterilization_runs_items_planned_item_to_sterilization_runs_planned_item_id" ON "public"."_m2m_sterilization_runs_items_planned_item";
CREATE TRIGGER "trg__m2m_sterilization_runs_items_planned_item_to_sterilization_runs_planned_item_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_sterilization_runs_items_planned_item"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_sterilization_runs_items_planned_item_to_sterilization_runs_planned_item_id"();
...
CREATE UNIQUE INDEX IF NOT EXISTS "_m2m_sterilization_runs_recipes_planned_recipe_sterilization_runs_id_uniq" ON "public"."_m2m_sterilization_runs_recipes_planned_recipe"("sterilization_runs_id");

CREATE OR REPLACE FUNCTION "public"."sync_sterilization_runs_planned_recipe_id_to__m2m_sterilization_runs_recipes_planned_recipe"()
RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
  -- prevent recursion when the junction trigger updates the base table
  IF pg_trigger_depth() > 1 THEN
...
DROP TRIGGER IF EXISTS "trg_sterilization_runs_planned_recipe_id_to__m2m_sterilization_runs_recipes_planned_recipe" ON "public"."sterilization_runs";
CREATE TRIGGER "trg_sterilization_runs_planned_recipe_id_to__m2m_sterilization_runs_recipes_planned_recipe"
AFTER INSERT OR UPDATE OF "planned_recipe_id" ON "public"."sterilization_runs"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_sterilization_runs_planned_recipe_id_to__m2m_sterilization_runs_recipes_planned_recipe"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_sterilization_runs_recipes_planned_recipe_to_sterilization_runs_planned_recipe_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    ...
    v_b := OLD."recipes_id";
    UPDATE "public"."sterilization_runs"
       SET "planned_recipe_id" = NULL
     WHERE "nocopk" = v_a
       AND "planned_recipe_id" = v_b;
    RETURN OLD;
  ELSE
    v_a := NEW."sterilization_runs_id";
    v_b := NEW."recipes_id";
...
DROP TRIGGER IF EXISTS "trg__m2m_sterilization_runs_recipes_planned_recipe_to_sterilization_runs_planned_recipe_id" ON "public"."_m2m_sterilization_runs_recipes_planned_recipe";
CREATE TRIGGER "trg__m2m_sterilization_runs_recipes_planned_recipe_to_sterilization_runs_planned_recipe_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_sterilization_runs_recipes_planned_recipe"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_sterilization_runs_recipes_planned_recipe_to_sterilization_runs_planned_recipe_id"();
...
AFTER INSERT OR UPDATE OF "lot_id" ON "public"."print_queue"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_print_queue_lot_id_to__m2m_print_queue_lots_lot_id"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_print_queue_lots_lot_id_to_print_queue_lot_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    ...
    RETURN OLD;
  ELSE
    v_a := NEW."print_queue_id";
    v_b := NEW."lots_id";

    -- Enforce single link: drop any other rows for this source id
    DELETE FROM "public"."_m2m_print_queue_lots_lot_id"
     WHERE "print_queue_id" = v_a
       AND "lots_id" <> v_b;
...
DROP TRIGGER IF EXISTS "trg__m2m_print_queue_lots_lot_id_to_print_queue_lot_id" ON "public"."_m2m_print_queue_lots_lot_id";
CREATE TRIGGER "trg__m2m_print_queue_lots_lot_id_to_print_queue_lot_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_print_queue_lots_lot_id"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_print_queue_lots_lot_id_to_print_queue_lot_id"();
...
CREATE OR REPLACE FUNCTION "public"."sync_print_queue_product_id_to__m2m_print_queue_products_product_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
BEGIN
  -- prevent recursion when the junction trigger updates the base table
  IF pg_trigger_depth() > 1 THEN
...
DROP TRIGGER IF EXISTS "trg_print_queue_product_id_to__m2m_print_queue_products_product_id" ON "public"."print_queue";
CREATE TRIGGER "trg_print_queue_product_id_to__m2m_print_queue_products_product_id"
AFTER INSERT OR UPDATE OF "product_id" ON "public"."print_queue"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_print_queue_product_id_to__m2m_print_queue_products_product_id"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_print_queue_products_product_id_to_print_queue_product_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
...
DROP TRIGGER IF EXISTS "trg__m2m_print_queue_products_product_id_to_print_queue_product_id" ON "public"."_m2m_print_queue_products_product_id";
CREATE TRIGGER "trg__m2m_print_queue_products_product_id_to_print_queue_product_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_print_queue_products_product_id"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_print_queue_products_product_id_to_print_queue_product_id"();
...
AFTER INSERT OR UPDATE OF "item_id" ON "public"."ecommerce"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_ecommerce_item_id_to__m2m_ecommerce_items_item_id"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_ecommerce_items_item_id_to_ecommerce_item_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
BEGIN
  ...
  IF TG_OP = 'DELETE' THEN
    ...
    RETURN OLD;
  ELSE
    v_a := NEW."ecommerce_id";
    v_b := NEW."items_id";

    -- Enforce single link: drop any other rows for this source id
    DELETE FROM "public"."_m2m_ecommerce_items_item_id"
     WHERE "ecommerce_id" = v_a
       AND "items_id" <> v_b;
...
DROP TRIGGER IF EXISTS "trg__m2m_ecommerce_items_item_id_to_ecommerce_item_id" ON "public"."_m2m_ecommerce_items_item_id";
CREATE TRIGGER "trg__m2m_ecommerce_items_item_id_to_ecommerce_item_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_ecommerce_items_item_id"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_ecommerce_items_item_id_to_ecommerce_item_id"();
...
AFTER INSERT OR UPDATE OF "strain_id" ON "public"."ecommerce"
FOR EACH ROW EXECUTE FUNCTION "public"."sync_ecommerce_strain_id_to__m2m_ecommerce_strains_strain_id"();

CREATE OR REPLACE FUNCTION "public"."sync__m2m_ecommerce_strains_strain_id_to_ecommerce_strain_id"()
RETURNS trigger LANGUAGE plpgsql AS $$
DECLARE
  v_a bigint;
  v_b bigint;
...
DROP TRIGGER IF EXISTS "trg__m2m_ecommerce_strains_strain_id_to_ecommerce_strain_id" ON "public"."_m2m_ecommerce_strains_strain_id";
CREATE TRIGGER "trg__m2m_ecommerce_strains_strain_id_to_ecommerce_strain_id"
AFTER INSERT OR UPDATE OR DELETE ON "public"."_m2m_ecommerce_strains_strain_id"
FOR EACH ROW EXECUTE FUNCTION "public"."sync__m2m_ecommerce_strains_strain_id_to_ecommerce_strain_id"();
