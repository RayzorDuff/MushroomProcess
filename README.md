# MushroomProcess 
# – Airtable/NocoDB Inventory & Labeling System
...
It is built on Airtable with a migration to NocoDB with mobile-friendly Interfaces for each station (sterilizer, inoculation, dark room, 
fruiting, harvest, packaging), and integrates with a Node-based print daemon to output 4×2 thermal labels (JADENS JD268BT-CA).

## Components
- Airtable/NocoDB base with tables: items, recipes, strains, locations, sterilization_runs, lots, events, products, print_queue.
