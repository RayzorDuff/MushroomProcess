/**
 * Auto-generated from airtable_interfaces/Interface_Package_Syringes.txt
 * Interface: Package Syringes
 * Table: lots
 *
...
async function main() {
  console.log(`🔧 Upserting view: Package Syringes`);
  ...
  const view = await upsertView(table.id, 'Package Syringes', meta);
  console.log(`✅ View ready: ${view.title || 'Package Syringes'} (id=${view.id || 'unknown'})`);
