/**
 * Auto-generated from airtable_interfaces/Interface_Spawn_to_Bulk.txt
 * Interface: Spawn to Bulk
 * Table: lots
 *
...
async function main() {
  console.log(`🔧 Upserting view: Spawn to Bulk`);
  ...
  const view = await upsertView(table.id, 'Spawn to Bulk', meta);
  console.log(`✅ View ready: ${view.title || 'Spawn to Bulk'} (id=${view.id || 'unknown'})`);
