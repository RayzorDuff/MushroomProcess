/**
 * Auto-generated from airtable_interfaces/Interface_Harvest.txt
 * Interface: Harvest
 * Table: lots
 *
...
async function main() {
  console.log(`🔧 Upserting view: Harvest`);
  ...
  const view = await upsertView(table.id, 'Harvest', meta);
  console.log(`✅ View ready: ${view.title || 'Harvest'} (id=${view.id || 'unknown'})`);
