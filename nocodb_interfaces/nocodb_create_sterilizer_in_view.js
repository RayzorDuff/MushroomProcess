/**
 * Auto-generated from airtable_interfaces/Interface_Sterilizer_In.txt
 * Interface: Sterilizer IN
...
async function main() {
  console.log(`🔧 Upserting view: Sterilizer IN`);
  ...
  const view = await upsertView(table.id, 'Sterilizer IN', meta);
  console.log(`✅ View ready: ${view.title || 'Sterilizer IN'} (id=${view.id || 'unknown'})`);
