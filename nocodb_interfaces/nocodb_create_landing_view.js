/**
 * Auto-generated from airtable_interfaces/Interface_Landing.txt
 * Interface: Landing
 * Table: lots
 *
...
async function main() {
  console.log(`🔧 Upserting view: Landing`);
  ...
  const view = await upsertView(table.id, 'Landing', meta);
  console.log(`✅ View ready: ${view.title || 'Landing'} (id=${view.id || 'unknown'})`);
