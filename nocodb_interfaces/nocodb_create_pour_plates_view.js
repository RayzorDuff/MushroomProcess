/**
 * Auto-generated from airtable_interfaces/Interface_Pour_Plates.txt
 * Interface: Pour Plates
 * Table: lots
 *
...
async function main() {
  console.log(`🔧 Upserting view: Pour Plates`);
  ...
  const view = await upsertView(table.id, 'Pour Plates', meta);
  console.log(`✅ View ready: ${view.title || 'Pour Plates'} (id=${view.id || 'unknown'})`);
